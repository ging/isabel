...
/////////////////////////////////////////////////////////////////////////
//
// $Id: statGatherer.cc 20759 2010-07-05 10:30:36Z gabriel $
//
/////////////////////////////////////////////////////////////////////////
                        ...
                        )
{
    ...
    {
        u16 index = getPosition(destAddr, ID_session,PT);
        ...
        rtcpSender_t *sender = new rtcpSender_t(destAddr,
                                                localRTCPport,
                                                (u32)(1.0/bitFreq),
                                                data,
                                                ID_session
                         ...
                         )
{
    ...
    u16 index = getPosition(addr, ID_session, payloadType);
...
{
    u8 payloadType = pkt->getPayloadType();
    u16 index = getPosition(addrOrig, ID_session, payloadType);
...
u16
statGatherer_t::getPosition(inetAddr_t const &addr,
                            u16 ID_session,
                            int PT
                           )
{
    ...
    while (session->IPList[position])
    {
        ...
        if (tmpStats)
        {
            if (tmpStats->IPAddr.equalIPAddr(addr))
            {
                break;
            }
        }
