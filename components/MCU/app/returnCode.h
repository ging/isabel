...
/////////////////////////////////////////////////////////////////////////
//
// $Id: returnCode.h 20759 2010-07-05 10:30:36Z gabriel $
//
/////////////////////////////////////////////////////////////////////////
...
//MessageId  = E_DEFRAGMENTER
//MessageStr = ERROR: Defragmenting data
#define E_DEFRAGMENTER          (HRESULT)0x80000017

//MessageId  = E_SILENCE_LEVEL
//MessageStr = ERROR: Silence level out of range
#define E_SILENCE_LEVEL         (HRESULT)0x80000018

//MessageId  = E_NAT_ERROR
//MessageStr = ERROR: ERROR: Nat Participant is not yet configurated
#define E_NAT_ERROR				(HRESULT)0x80000019

//MessageId  = E_NAT_PORT
//MessageStr = ERROR: ERROR: Port not available for Nat Participants
#define E_NAT_PORT				(HRESULT)0x80000020
