...
/////////////////////////////////////////////////////////////////////////
//
// $Id: flowProcessor.cc 7065 2005-07-04 15:00:06Z sirvent $
//
/////////////////////////////////////////////////////////////////////////
...
flowProcessor_t::getProcessorArray(flow_t &inFlow)
{
    ...
    if ( ! outFlowMatrix[position])
    {
        outFlowMatrix[position] = new vector_t<outFlow_t *>;
    }

    return outFlowMatrix[position];
}
