...
/////////////////////////////////////////////////////////////////////////
//
// $Id: statGatherer.h 6611 2005-05-09 11:41:02Z sirvent $
//
/////////////////////////////////////////////////////////////////////////
...
private:
    ...
    u16 getPosition(sockaddr_storage const &IP, u16 ID_session, u8 PT);
...
public:
    ...
    // From Demux
    HRESULT setRXData(RTPPacket_t *pkt, sockaddr_storage const IPOrig, u16 ID_session);
