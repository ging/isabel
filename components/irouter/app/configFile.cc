...
/////////////////////////////////////////////////////////////////////////
//
// $Id: configFile.cc 20759 2010-07-05 10:30:36Z gabriel $
//
/////////////////////////////////////////////////////////////////////////
...
confIrouter_Interface_t::irouter_multicast_ttl(int argc, char **argv)
{
   ...
   debugMsg(dbg_App_Verbose, "irouter_multicast_ttl", "TTL=%d\n", mcastTTL);
...
confIrouter_Interface_t::irouter_multicast_bw(int argc, char **argv)
{
   ...
   debugMsg(dbg_App_Verbose, "irouter_multicast_bw", "BW=%d\n", mcastBw);
...
confIrouter_Interface_t::irouter_up_stream_bw(int argc, char **argv)
{
   ...
   debugMsg(dbg_App_Verbose, "irouter_up_stream_bw", "Bw=%d\n", upStreamBw);
...
confIrouter_Interface_t::irouter_down_stream_bw(int argc, char **argv)
{
   ...
   debugMsg(dbg_App_Verbose, "irouter_down_stream_bw", "Bw=%d\n", downStreamBw);
...
confIrouter_Interface_t::irouter_define_flow(int argc, char **argv)
{
   ...
   debugMsg(dbg_App_Verbose, "irouter_define_flow", "flowName=%s\n", flowName);
