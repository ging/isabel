...
/////////////////////////////////////////////////////////////////////////
//
// $Id: link.hh 10635 2007-08-22 17:32:16Z gabriel $
//
/////////////////////////////////////////////////////////////////////////
...
private:
    ...
    bool shouldEcho; /*!< Boolean to indicate if echo is made in
                          this link, it means, packets received
...
//    virtual void copyPktToTargets(sharedPkt_t * &pkt);
    ...
    /*! Normally we use one destination target by each link, this
        ...
        \param pt payload type = flowId_e
    ...
    */
//    virtual int  addTarget(const int pt, const char *addr,
  //                         const int port, int n, int k, const i8 mcastTTL=0);
    ...
    */
//    virtual void delTarget(const int id);

//    virtual target_t *getTarget(int pt, const char *addr);
  //  virtual target_t *getMcastTarget(int pt);

//    virtual void protectFlow(char *addr, flowId_e flowId, char *fecType, int n, int k);


    //videoTranscode(SSRC,dest,BW,Codec)
    //looks up dest target and creates a transcoder module
  //  virtual bool videoTranscode(u32 SSRC,char * dest,u32 BW,u8 Codec);
...
//    int leaveSSM(char * source);
    ...
    /*!
        ...
        \sa sharedPkt_ref
    */
    //virtual inetAddr_t *getAddr(const int targetId);

    //! Change bandwidth used by the traffic shaping function
    //virtual void adjustBandWidth(const u32 bw) { outd->adjustBandWidth(bw); }
...
class linkBinder_t: public virtual item_t,
