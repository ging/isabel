...
/////////////////////////////////////////////////////////////////////////
//
// $Id: configParam.cc 10661 2007-08-27 17:36:28Z santiago $
//
/////////////////////////////////////////////////////////////////////////
...
void 
irouterParam_t::setNotifyFile(const char * file)
{
	if (notifyFile)
	{
		free(notifyFile);
	}
	notifyFile = strdup(file);
}

const char * 
irouterParam_t::getNotifyFile(void)
{
	return notifyFile;
}
...
void
irouterParam_t::setMulticastSources(charList_t sources)
