...
public class NetworkManager {
	 ...
	 * 
	 * @param ic The IsabelClient which create this object.
	 */
	public NetworkManager(IsabelClientImpl ic) {

		mylogger = Logger.getLogger("isabel.gw.isabel_client.NetworkManager");
		mylogger.info("Creating NetworkManager object.");
