...
/**
 * Esta clase representa el componente de ConferenceCtrl.
 *
 */
public class ConferenceCtrlComponent extends Component {
     ...
     */
    public ConferenceCtrlComponent(IsabelClientImpl ic){  
	super("ConferenceCtrl");
	
    	mylogger = Logger.getLogger("isabel.gw.isabel_client.components.ConferenceCtrlComponent");
    	mylogger.info("Creating ConferenceCtrlComponent object.");
...
@Override
	...
	mylogger.info("Start my ConferenceCtrl component.");
	super.start();
	...
	mylogger.info("Stop my ConferenceCtrl component.");
	super.stop();
    }
	...
	mylogger.info("Joining me to the ConferenceCtrl component.");
	super.addMe();
    }
