...
public class GraphicalUA extends JFrame implements UserAgentListener, RegisterAgentListener
{
   ...
   public GraphicalUA(SipProvider sip_provider, UserAgentProfile user_profile)
   {
      ...
      ua.listen();
      ra=new RegisterAgent(sip_provider,user_profile.from_url,user_profile.contact_url,user_profile.username,user_profile.username,user_profile.realm,user_profile.passwd,this);
