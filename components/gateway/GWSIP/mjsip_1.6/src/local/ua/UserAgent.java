...
{           
   ...
   public void addMediaDescriptor(String media, int port, int avp, String codec, int rate, boolean put_channels)
   ...
   {  this.sip_provider=sip_provider;
      ...
      //No tenemos formatos por defecto
   ...
   {  printLog("onCallIncoming()",LogLevel.LOW);
      ...
      if (sdp!=null)
      {  
    	 // TODO: Generar atributos de SSRC y pasarlos a la aplicacion principal.
    	 // Create the new SDP
      ...
      if (listener!=null) listener.onUaCallIncoming(this,remote_sdp,callee,caller);
   }  
