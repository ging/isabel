...
echo "---------------Test2----------------------"
echo "Prueba de mensajes locales para el SeCo"
...
xterm -e sh -c "sleep 3; java -Djava.util.logging.config.file=/home/jcvalle/.isabel/config/logging.properties -cp $JARS isabel.seco.tests.test2.StartAplications $1; echo fin; sleep 1000;" &

else 
	
echo "Using log file: ResultadosTest2.txt"
...
xterm -e sh -c "sleep 3; java -cp $JARS isabel.seco.tests.test2.StartAplications; echo fin; sleep 1000;" &
