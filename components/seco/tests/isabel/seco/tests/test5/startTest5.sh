...
echo "JARS=" $JARS
xterm -e sh -c "java -cp $JARS  -agentlib:hprof=cpu=samples,depth=1,file=analisis,interval=5 isabel.seco.server.SeCo ; echo fin; sleep 1000;" & 
xterm -e sh -c "java -cp $JARS isabel.seco.tests.test5.Aplicacion2 $*; echo fin; sleep 1000;" &  
xterm -e sh -c "sleep 1; java -cp $JARS isabel.seco.tests.test5.Aplicacion1 $*; echo fin; sleep 1000;"
