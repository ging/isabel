...
echo "Entre varios clientes y receptores con mensajes"
...
cont=1
while true ; do
   java -cp $JARS isabel.seco.tests.test5.PruebaReceptor $cont &
...
cont=1
while true ; do
   java -cp $JARS isabel.seco.tests.test5.PruebaCliente $cont &
