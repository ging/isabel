...
jarlib=$ISABEL_DIR/libexec/isabel_xlimservices.jar:$ISABEL_DIR/libexec/xedl.jar:$ISABEL_DIR/lib/images/xlim/:$ISABEL_DIR/libexec/isabel_xlim.jar:$ISABEL_DIR/lib/:$ISABEL_DIR/lib/images/:$ISABEL_DIR/libexec/isabel_lib.jar:$ISABEL_DIR/libexec/isabel_tunnel.jar:$XMLRPCJARS
...
$ISAJAVA -cp $jarlib \
            ...
            services.isabel.services.gxedl.isabelXEDLViewer $DEFAULT_XEDL  &
