...
/////////////////////////////////////////////////////////////////////////
//
// $Id: Crypt.java 20206 2010-04-08 10:55:00Z gabriel $
//
/////////////////////////////////////////////////////////////////////////
...
public class Crypt {
    ...
    */
    ...
    /**
     * Checks if the new passwd is equals to the old one. First, the new passwd
     * is encrypted and then compared with the old passwd.
     * @param newPasswd The passwd we want to check.
     * @param oldPasswd the old passwd.
     * @returns true if the new passwd is equals to the old one.
     */
    public static boolean checkPasswd (String newPasswd, String oldPasswd) {
      // Cogemos la salt, que son los dos primeros caracteres del oldPasswd:
      String salt = oldPasswd.substring(0,2);
      //Encriptamos la nueva passwd.
      String encryptedPasswd = crypt(salt,newPasswd);
      if (encryptedPasswd.equals(oldPasswd)) return true;
      else return false;
    }
