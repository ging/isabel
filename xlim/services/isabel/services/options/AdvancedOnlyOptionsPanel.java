 ...
 */
/*
 * AdvancedOnlyOptionsPanel.java
 *
 * Created on 29 de octubre de 2003, 14:11
 */
 ...
 */
public class AdvancedOnlyOptionsPanel extends JPanel implements OptionsStrings, ConnectionModePanelListener {    
    ...
    public MulticastGroupsPanel multicastGroupsPane;
     ...
     */
    public AdvancedOnlyOptionsPanel() {
        initComponents();
        enableButtons();
    }        
...
//        tabbedPane.addTab("Site ID", siteIDPane);
        ...
        multicastGroupsPane = new MulticastGroupsPanel();
        tabbedPane.addTab("Multicast", multicastGroupsPane);
    ...
    public static void main (String [] args) {
        ...
        frame.getContentPane().add(new AdvancedOnlyOptionsPanel());
        frame.pack();
