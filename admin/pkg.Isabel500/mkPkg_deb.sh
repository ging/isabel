...
Depends: iwidgets4, m4, tightvncserver, twm, openvpn, freeglut3, libgsm1, libmp3lame0, libspeex1, libopencore-amrnb0, libopencore-amrwb0, libx264-dev, libxvidcore4, libportaudio2, libpng12-0, jwm, sharutils, gamix
Essential: no
Installed-Size: 7 MB
