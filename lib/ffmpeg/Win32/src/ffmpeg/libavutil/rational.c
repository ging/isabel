...
#else
            {
                AVRational __newA1= {x*a1.num + a0.num, x*a1.den + a0.den};
                a1= __newA1;
            }
#endif
            break;
...
#else
    AVRational __newC= {c.den, c.num};
    return av_mul_q(b, __newC);
#endif
}
