...
void 
CD3Des::deskey(unsigned char *key, EMode edf)
{
    int i, j, l, m, n;
...
void 
CD3Des::cookey(unsigned long *raw1)
{
...
void 
CD3Des::cpkey(unsigned long *into)
{
...
void 
CD3Des::usekey(unsigned long *from)
{
...
void 
CD3Des::des(unsigned char *inblock,unsigned char * outblock)
{
...
void 
CD3Des::scrunch(unsigned char *outof, unsigned long *into)
{
    *into	 = (*outof++ & 0xffL) << 24;
    *into	|= (*outof++ & 0xffL) << 16;
    *into	|= (*outof++ & 0xffL) << 8;
...
void 
CD3Des::unscrun(unsigned long *outof, unsigned char *into)
{
    *into++ = (*outof >> 24) & 0xffL;
    *into++ = (*outof >> 16) & 0xffL;
    *into++ = (*outof >>  8) & 0xffL;
...
void 
CD3Des::desfunc(unsigned long *block, unsigned long *keys)
{
