 ...
 */
int g726_16_encoder(	int		sl, struct g72x_state *state_ptr) {
 ...
 */
int g726_16_decoder(	int		i,	struct g72x_state *state_ptr) {
...
/*
	switch (out_coding) {
	case AUDIO_ENCODING_ALAW:
		return (tandem_adjust_alaw(sr, se, y, i, 2, qtab_726_16));
	case AUDIO_ENCODING_ULAW:
		return (tandem_adjust_ulaw(sr, se, y, i, 2, qtab_726_16));
	case AUDIO_ENCODING_LINEAR:
