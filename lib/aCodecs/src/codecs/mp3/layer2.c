...
/* $Id: layer2.c,v 1.23 2008/06/25 21:59:39 robert Exp $ */
...
static void
II_step_two(PMPSTR mp, unsigned int *bit_alloc,real fraction[2][4][SBLIMIT],int *scale,struct frame *fr,int x1)
{
    int i,j,k,ba;
