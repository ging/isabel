...
extern const real cb_shape[][5];
extern const real cb_gain[];

/* Double Gains: */
extern const real cb_gain2[];

/* Midpoints: */
extern const real cb_gain_mid[];

/* Squared Gains: */
extern const real cb_gain_sq[];
...
extern const real hw_gain[];
extern const real hw_percw[];
extern const real hw_synth[];
