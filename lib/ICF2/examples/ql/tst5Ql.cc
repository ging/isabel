...
/////////////////////////////////////////////////////////////////////////
//
// $Id: tst5Ql.cc 20206 2010-04-08 10:55:00Z gabriel $
//
...
// ------------------------------------------------------------------
// PRUEBA DE PUNTERO A LISTA DE PUNTEROS INTELIGENTES DE ENTERO: 
// ql_t<int_ref> *
//    Se crean punteros a listas, por tanto, la 
//    lista cuando se deje de utilizar hay que liberarla.
...
// definimos un nuevo tipo de listas de punteros inteligentes a entero
// para ello se puede usar:
// typedef ql_t<int_ref> intRefList_t;
// pero nosotros vamos a derivar de esta clase para redefinir el 
// destructor que imprimira un mensaje cuando se invoque, para saber 
// exactamente cuando se destruye la lista. Y ademas le pasamos en 
// el constructor un identificador para saber que lista es la que
// estamos destruyendo
...
main()
{

    {
        ...
        intRefList_t *s1 = new intRefList_t(1);
        intRefList_t *s2 = new intRefList_t(2);
        ...
        *s1= *s2;
        ...
        // Como acba el ambito donde estaban definidas s1 y s2 hay
        // que liberar la memoria reservada para estas listas.
        delete s1;
        delete s2;

        printf("Borradas explicitamente\n");
