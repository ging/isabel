...
/////////////////////////////////////////////////////////////////////////
//
// $Id: testSmartReference2.cc 20206 2010-04-08 10:55:00Z gabriel $
//
...
//------------------------------------------------------------
// EJEMPLO DE ASIGNACION DE LOS PUNTEROS INTELIGENTES
// -----------------------------------------------------------
//
...
//    "delete" (en el destructor se imprime -obji) y como
//    funciona la asignacion
//------------------------------------------------------------
...
main()
{
...

    {
        ...
        // automatica x3, pero no obj3 porque x1 lo esta usando  
    }
